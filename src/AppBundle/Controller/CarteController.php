...
class CarteController extends Controller
{
     ...
     *
     * @Route("/", name="administration_carte_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="administration_carte_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('administration_carte_show', array('id' => $carte->getId()));
        }
     ...
     *
     * @Route("/{id}", name="administration_carte_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="administration_carte_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Carte $carte)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('administration_carte_edit', array('id' => $carte->getId()));
        }
     ...
     *
     * @Route("/{id}", name="administration_carte_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Carte $carte)
    {
        ...
        return $this->redirectToRoute('administration_carte_index');
    }
    ...
    private function createDeleteForm(Carte $carte)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('administration_carte_delete', array('id' => $carte->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
